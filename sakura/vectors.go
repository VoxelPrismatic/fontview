...
var Vectors = SakuraSwatch[func(int) int]{
	Dawn: SakuraPalette[func(int) int]{
		Hl: SakuraHl[func(int) int]{
		...
		Layer: SakuraLayer[func(int) int]{
		...
		Paint: SakuraPaint[func(int) int]{
	...
	Main: SakuraPalette[func(int) int]{
		Hl: SakuraHl[func(int) int]{
	...
	Moon: SakuraPalette[func(int) int]{
		Hl: SakuraHl[func(int) int]{
